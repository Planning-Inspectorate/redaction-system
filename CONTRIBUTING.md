...
documentation such as [detect-secrets][detect-secrets-repo].

## Code conventions

We follow [PEP8 standards][pep8] in our code conventions, and use [ruff
pre-commit hook][ruff] for linting and formatting.
...
only extends to Python scripts in the `redaction_system` folder.
