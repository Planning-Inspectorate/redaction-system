...
class FoundryModelDeployer:
    ...
    def deploy_models(self):
        ...
        print("The following models have already been deployed")
        print(json.dumps(all_deployed_models, indent=4))
        print("The following deployed models will be created")
        print(json.dumps(list(model_names_to_create), indent=4))
        print("The following deployed models will be updated")
        print(json.dumps(list(model_names_to_update), indent=4))
...
if __name__ == "__main__":
    ...
    resource_group_name = f"pins-rg-redaction-{env}-uks"
