...
CASES = [
    EvaluationCase(
        ...
        fixture_pdf="eval_dataset.pdf",
        in_name="eval_dataset_source.pdf",
        proposed_name="eval_dataset_proposed.pdf",
        out_name="eval_dataset_redacted.pdf",
        expected_strings_file="eval_dataset_expected.json",
