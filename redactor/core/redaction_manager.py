...
class RedactionManager:
    ...
    def _compare_redactions(
        ...
        proposed_redactions_df = pd.json_normalize(
            proposed_redactions_dict.get("proposedRedactions", [])
        )
        if proposed_redactions_df.empty:
            LoggingUtil().log_info(
        ...
        final_redactions_df = pd.json_normalize(
            final_redactions_dict.get("finalRedactions", [])
        )[columns_to_compare]
